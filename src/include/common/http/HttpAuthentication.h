...
public:
    virtual void setUsername(const StringBuffer& user) = 0;
    virtual StringBuffer getUsername() = 0;

    virtual void setPassword(const StringBuffer& psas) = 0;
    virtual StringBuffer getPassword() = 0;
