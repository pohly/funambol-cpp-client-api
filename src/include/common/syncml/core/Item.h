...
class Item : public ArrayElement {
    ...
    public:
         ...
         */
        wchar_t* getTargetParent(wchar_t* parent = NULL);
         ...
         *
         */
        void setTargetParent(wchar_t* parent);    
         ...
         */
        wchar_t* getSourceParent(wchar_t* parent = NULL);
         ...
         *
         */
        void setSourceParent(wchar_t* parent);
