...
#define PROPERTY_MAIL_ACCOUNT_VISIBLE_NAME		"mailAccounts/%s/VisibleName"
#define PROPERTY_MAIL_ACCOUNT_EMAILADDRESS		"mailAccounts/%s/EmailAddress"
#define PROPERTY_MAIL_ACCOUNT_PROTOCOL			"mailAccounts/%s/Protocol"
#define PROPERTY_MAIL_ACCOUNT_USERNAME			"mailAccounts/%s/Username"
#define PROPERTY_MAIL_ACCOUNT_PASSWORD			"mailAccounts/%s/Password"
#define PROPERTY_MAIL_ACCOUNT_IN_SERVER			"mailAccounts/%s/IncomingServer"
#define PROPERTY_MAIL_ACCOUNT_OUT_SERVER		"mailAccounts/%s/OutgoingServer"
#define PROPERTY_MAIL_ACCOUNT_IN_PORT			"mailAccounts/%s/PortIn"
#define PROPERTY_MAIL_ACCOUNT_OUT_PORT			"mailAccounts/%s/PortOut"
#define PROPERTY_MAIL_ACCOUNT_IN_SSL			"mailAccounts/%s/IncomingSSL"
#define PROPERTY_MAIL_ACCOUNT_OUT_SSL			"mailAccounts/%s/OutcomingSSL"
#define PROPERTY_MAIL_ACCOUNT_SIGNATURE			"mailAccounts/%s/Signature"
#define PROPERTY_MAIL_ACCOUNT_DOMAINNAME		"mailAccounts/%s/DomainName"
#define PROPERTY_MAIL_ACCOUNT_ID				"mailAccounts/%s/ID"
