 ...
 */
DigestAuthentication::DigestAuthentication(const StringBuffer& name, const StringBuffer& password) {
	this->username = name;
 ...
 */
void DigestAuthentication::setUsername(const StringBuffer& username) {
	this->username = username;
}

/**
 * Get the username for the current authentication.
 */
StringBuffer DigestAuthentication::getUsername() {
	return username;
}
 ...
 */
void DigestAuthentication::setPassword(const StringBuffer& password) {
	this->password = password;
}

/**
 * Get the password for the current authentication.
 */
StringBuffer DigestAuthentication::getPassword() {
	return password;
}
