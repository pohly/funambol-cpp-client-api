...
*
*/
SessionID::SessionID(wchar_t* sessionID) {
    this->sessionID = NULL;
...
*/
wchar_t* SessionID::getSessionID(wchar_t* retSessionID) {
     if (retSessionID == NULL) {
        return sessionID;
    }
    return wcscpy(retSessionID, sessionID);
}
...
*/
void SessionID::setSessionID(wchar_t* sessionID) {
    if (this->sessionID) {
